        ...
        <div className="mx-auto max-w-7xl px-4 py-20 md:px-8 lg:px-10">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2 xl:grid-cols-5">
            {pricingBands.map((item) => (
              <div key={item.title} className="rounded-[30px] border border-white/10 bg-white/[0.06] p-6 shadow-panel backdrop-blur-xl transition duration-300 hover:-translate-y-1 hover:border-[#ffbc92]/35">
